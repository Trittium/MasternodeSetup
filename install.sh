...
COIN_TGZ='https://github.com/Trittium/trittium/releases/download/v4.0.0.0/Trittium-4.0.0.0-Linux.zip'
...
function important_information() {
 ...
 echo -e "${GREEN}trittium-cli getmasternodestatus${NC}"
 echo -e "${GREEN}trittium-cli getinfo${NC}"
 echo -e "${BLUE}================================================================================================================================${NC}"
